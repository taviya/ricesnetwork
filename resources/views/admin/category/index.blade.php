        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <button type="button" id="add_user" class="float-end btn btn-primary" data-bs-toggle="modal" data-bs-target=".category_add">Add Category <i class="fas fa-plus"></i></button>
                </div>
                <div class="card-body">
